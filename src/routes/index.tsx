      ...
      <section className="relative">
        ...
        <div className="container mx-auto px-4 py-12 md:py-20 grid md:grid-cols-2 gap-10 items-center relative">
          ...
          <div className="order-1 md:order-2 relative flex justify-center">
            ...
            <img src={mascot} alt="Marhabo Fox Mascot" className="relative w-72 md:w-[420px] float-anim drop-shadow-2xl" />
...
function TemplateCard({ t, idx }: { t: Tpl; idx: number }) {
  ...
  return (
    <div className="card-pop p-6 relative overflow-hidden">
      ...
      {t.is_available ? (
        <button className="bubble-btn !py-2 !px-5 text-sm text-white" style={{ background: color }}>{tr("use_template")}</button>
      ) : (
